...
@implementation WDUIColor (WDAdditions)
...
+ (WDUIColor *) randomColor:(BOOL)includeAlpha
{
    ...
    return [WDUIColor colorWithRed:components[0] green:components[1] blue:components[2] alpha:alpha];
}
...
+ (WDUIColor *) saturatedRandomColor
{
    ...
    return [WDUIColor colorWithHue:(hue / 10000) saturation:0.69f brightness:0.75f alpha:1.0];
}
